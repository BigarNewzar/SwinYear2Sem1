...
public class MyCustomerManagedBean implements Serializable {
    ...
    public String addCustomerTransaction() {
        ...
        CustomerDTO customerDTO = new CustomerDTO(transaction_id, firstname, lastname, email, address, suburb, postcode, phone, price, quantity, comment, credit_card_name, credit_card_number, credit_card_expiry_date, credit_card_CVV);
    ...
    public String setCustomerTransactionDetailForChange() {
        // check transaction_id is null
        ...
        // get customer's transaction details
        return setCustomerTransactionDetails();
    }

    public String changeCustomerTransaction() {
        // check transaction_id is null
        if (isNull(transaction_id)) {
            return "debug";
        }
        ...
        CustomerDTO customerDTO = new CustomerDTO(transaction_id, firstname, lastname, email, address, suburb, postcode, phone, price, quantity, comment, credit_card_name, credit_card_number, credit_card_expiry_date, credit_card_CVV);
        boolean result = customerTransactionManagement.updateCustomerTransactionDetails(customerDTO);
    ...
    public String removeCustomerTransaction() {
        // check transaction_id is null
        if (isNull(transaction_id)) {
            return "debug";
        }

        boolean result = customerTransactionManagement.removeCustomerTransaction(transaction_id);
    ...
    public String Enquire() {
        ...
        if ((transaction_id != null) && (firstname != null) && (lastname != null) && (email != null) && (address != null) && (suburb != null) && (postcode != null) && (phone != null) && (price != null) && (quantity != null) && (comment != null)) {
            if (!customerTransactionManagement.hasCustomerTransaction(transaction_id)) {
                result = "success";
                // note the startConversation of the conversation
                startConversation();
